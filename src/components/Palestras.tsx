...
const Palestras = () => {
  ...
  return (
    <section id="palestras" className="py-20 px-4 bg-gradient-to-b from-background to-accent/10">
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {temas.map((tema, index) => {
            ...
            return (
              <div
                key={index}
                className="bg-card p-6 rounded-xl shadow-md hover:shadow-lg transition-all animate-fade-in border border-border"
        ...
        <div className="bg-gradient-to-br from-primary to-primary/90 p-8 md:p-12 rounded-xl text-center animate-fade-in">
          <h3 className="text-2xl md:text-3xl font-bold text-primary-foreground mb-4">
            Agende uma palestra para sua empresa
          </h3>
          <p className="text-primary-foreground/95 mb-6 max-w-2xl mx-auto">
          ...
          <a
            ...
            className="inline-flex items-center gap-2 bg-accent text-accent-foreground px-8 py-4 rounded-lg font-semibold hover:bg-accent/90 transition-all"
          >
